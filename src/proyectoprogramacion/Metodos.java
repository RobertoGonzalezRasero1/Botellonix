 ...
 *
 * @author Arasa
 * Estos son los metodos basicos que creeo que usaremos si hacen falta mas se acaba en clase o decimelo y el domingo le añado mas cosas
 * si se os ocurre algo 
 * hecharle un ojillo y ya el martes los metemos a la interfaz grafica 
 * 
 */
public class Metodos {
    ...
    //Añado Items esto habra que meterlo en un bucle para que lo pregunte hasta que se le de a salir 
            public void addItem(){
        item.add(JOptionPane.showInputDialog("Introduce el producto ha almacenar"));
    }
